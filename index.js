...
Do you follow it, or continue on your path?`)
    ...
    if(secondAnswer === 'follow'){
        let thirdAnswer = window.prompt(`You follow the cat to a colony of cats, nestled in a fort of warm 
        blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you 
        wonder if you should alert the world to this magical safe haven.`)
        if (thirdAnswer === 'stay'){
    ...
    you see a shiny chest of treasure. Another path would lead you away from the dragon altogether. Which path do you take?`)
    ...
    if(secondAnswer === 'past the dragon'){
        ...
        if(thirdAnswer === 'draw it'){
            ...
            somewhat disappointed, but over time, discover joy in sharing it with your friends and family, 
